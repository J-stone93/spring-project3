...
public class MemoRepositoryTest1_1 {
	...
	@Test
	public void 데이터등록() {
		// no는 auto_increment이므로 빈값을 넣어도 됨
		Memo memo = new Memo(0, "새글입니다");

		// 해당 데이터가 없으면 insert 명령이 실행됨
	...
	public void 데이터일괄등록() {
		...
		Memo memo2 = new Memo(0, null); // text는 null 입력가능 n.n임
	...
	public void 데이터수정() {
		...
		// save는 select로 찾아 데이터가 있으면 update 없으면 insert 
